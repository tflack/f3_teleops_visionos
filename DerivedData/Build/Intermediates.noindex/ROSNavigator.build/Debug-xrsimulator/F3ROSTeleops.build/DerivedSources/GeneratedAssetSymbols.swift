...
extension DeveloperToolsSupport.ImageResource {
    ...
    /// The "robot_icon" asset catalog image resource.
    static let robotIcon = DeveloperToolsSupport.ImageResource(name: "robot_icon", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "robot_icon" asset catalog image.
    static var robotIcon: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .robotIcon)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "robot_icon" asset catalog image.
    static var robotIcon: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .robotIcon)
#else
        .init()
